		...
		if(in_array($end, $allowed_ext)){
			if($previous){
				if(move_uploaded_file($image, $path)){
					mysqli_query($conn, "UPDATE `projectdetails` set `projectname`='$projectname',`title`='$title',`description`='$description',`area`='$area',`videolink`='$videolink',`summary`='$summary',`category`='$category',`fillter`='$fillter',`image` ='$name' WHERE `id`='$id'");
