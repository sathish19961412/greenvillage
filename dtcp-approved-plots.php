...
<div class="page-title page-main-section parallaxie" style="background-image: url(images/bg-8.jpg);">
  <div class="container padding-bottom-top-120 text-uppercase text-center">
    <div class="main-title">
      ...
      <a href="index.php">home</a><span><i class="fa fa-angle-double-right" aria-hidden="true"></i></span><a href="farm-land.php">Farm Land</a> 
    </div>
  </div>
</div>
<!--===== #/PAGE TITLE =====-->
...
<section id="property" class=" padding">
  <div class="container">
    ...
    <?php
            ...
            $query=mysqli_query($conn,"SELECT*FROM projectdetails WHERE category='DTCP Approved Plots'");
